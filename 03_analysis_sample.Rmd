...
wau_jenks <- getJenksBreaks(wau_working$wau_area, 6)
...
dist<-ggplot(data=wau_working) +
  geom_histogram(mapping = aes(x=wau_area), binwidth = 50) +
...
dist_log<-ggplot(data=wau_working) +
  geom_histogram(mapping = aes(x=log_area), binwidth = 0.1) +
  ggtitle("Log Transformed Data") 
dist_log 

#qq plot - normality test
log_qq <- ggqqplot(wau_working$log_area) +
  ggtitle("Normality Test - Log Transformed Data")
log_qq

ks.test(wau_working$log_area, "pnorm")



# hist - sqrt data
dist_sqrt<-ggplot(data=wau_working) +
  geom_histogram(mapping = aes(x=sqrt_area), binwidth = 5) +
  ggtitle("Square Root Transformed Data") 
dist_sqrt

#qq plot - normality test
sqrt_qq <- ggqqplot(wau_working$sqrt_area) +
  ggtitle("Normality Test - Square Root Transformed Data")
sqrt_qq


#normality-test - sqrt
ks.test(wau_working$sqrt_area, "pnorm")
